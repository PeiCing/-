...
# 摘要
人體解剖生理學為國立臺東大學運動競技學士學位學程之必修科目，培養學生熟悉人體生理結構，使學生瞭解人體生理變化現象，進而利用該知識，實際應用於運動與訓練。

協助部分:  

我們以Unity作為平台，開發一個雙語學習解剖學的教學遊戲，利用拼圖、透視和敲擊的方式進行遊戲，學習手部、腿部及核心部位等骨頭和肌肉的分布。
系統會記錄學生遊玩的登入時間、成績和失誤，讓老師能掌握學生的學習狀況，提供及時協助。
